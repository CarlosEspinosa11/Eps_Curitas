...
<%
    ...
    try{
        ...
        String consultaSQL = "insert into registro (nombre, apellido, cedula, correo,numero, direccion, estadocivil,fechanacimiento,contrasena) values ";
        consultaSQL+= "('" + nombre + "','" + apellido + "','" + cedula + "','" + correo + "','" + numero + "','" + direccion + "','" + estadocivil + "','" + fechanacimiento + "','" + contrasena+"')";
