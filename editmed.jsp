...
<%
    ...
    try{
       ...
       conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/eps", "root", "");
        ...
        String consultaSQL = "UPDATE citasmedicas SET nombre = '"+nombre+"', apellido = '"+apellido+"', cedula='" + cedula + "',correo='" + correo + "',doctor='" + doctor + "',direccion='" + direccion + "',areasalud'" + areasalud + "',fecha='" + fecha+ "',precio='" + precio+ "' WHERE cedula="+cedula+"; ";
