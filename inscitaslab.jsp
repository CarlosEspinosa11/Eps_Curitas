...
<%
    ...
    try{
        ...
        String consultaSQL = "insert into citaslabo (nombre, apellido, cedula, correo, numero, direccion, precio, tipoexamen,fecha) values ";
        consultaSQL+= "('" + nombre + "','" + apellido + "','" + cedula + "','" + correo + "','" + numero + "','" + direccion + "','" + precio + "','" + tipoexamen + "','" + fecha+"')";
