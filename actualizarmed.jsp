    ...
    <body class="page">
        ...
        <!-- Nav Bar End -->
         ...
         <%
            ...
            String consultaSQL=  " select * from citasmedicas where cedula = ";
        ...
        <main class="contenedor">
            <form action = "inscitasmed.jsp" class="formulario" method="post">
                ...
                <div>
                    <h1 class="registro">Editar Citas Medicas</h1>
                </div>

        <form action="editmed.jsp" method="post" class="formulario" >
        <div class="  form-datos"> 
            ...
            <input type="text" name="doctor" class=" col-md-10"  size="10" id="formGroupExampleInput" placeholder="Digite el doctor familiar"  value="<%=rs.getString("doctor")%>"><br>
        ...
        <div class=" form-genero ">
            ...
            <label for="ginecologo" class="ginecologo">
                <input type="radio" name="areasalud" id="ginecologo"  value="Ginecologo" <%if(rs.getString("areasalud").equals("Ginecologo")){%>checked<%}%>>Ginecologo 
            </label>
            <br>

            <label for="psiquiatra" class="psiquiatra">
                <input type="radio" name="areasalud" id="psiquiatra" value="Psiquiatra" <%if(rs.getString("areasalud").equals("Psiquiatra")){%>checked<%}%>>Psiquiatra
            </label>
            <br>

            <label for="oncologo" class="oncologo">
                <input type="radio" name="areasalud" id="oncologo" value="Oncologo" <%if(rs.getString("areasalud").equals("Oncologo")){%>checked<%}%>>Oncologo
            </label>
            <br>

            <label for="odontologo" class="unionlibre">
                <input type="radio" name="areasalud" id="odontologo" value="Odontologo"<%if(rs.getString("areasalud").equals("Odontologo")){%>checked<%}%>>Odontologo
            </label>
            <br>

            <label for="optometria" class="optometria">
                <input type="radio" name="areasalud" id="optometria" value="Optometria"<%if(rs.getString("areasalud").equals("Optometria")){%>checked<%}%>>Optometria
                </label>
        </div>
        <!--DATOS ELECCION(FECHA)-->
        <div class="form-fecha"><br>
             <label for="fecha" class="negrilla" value="<%=rs.getString("fecha")%>">Fecha de Cita</label><br><br>
                <input type="date" name="trip-fecha" id="fecha">
        </div>
        <br><br>
