...
<html lang="es">
    ...
    <div class="navbar navbar-expand-lg bg-dark navbar-dark">
       ...
       <br><br><br><br><br><br><h1 class="text-center">Citas Laboratorios</h1><br>
...
<tbody>
        ...
        <%
            ...
            try{
                ...
                String consultaSQL = "select * from citaslabo";
