...
<html lang="es">
    ...
    <div class="navbar navbar-expand-lg bg-dark navbar-dark">
       ...
       <br><br><br><br><br><br><h1 class="text-center">Citas Médicas</h1><br>
...
<tbody>
        ...
        <%
            ...
            try{
                ...
                String consultaSQL = "select * from citasmedicas";
                ...
                while(rs.next()){ %>
                    ...
                    <center>
                        ...
                        <p class="variable"><b>Area Salud: </b><%=rs.getString("areasalud")%> </p> 
                        <p class="variable"><b>Doctor: </b><%=rs.getString("doctor")%> </p> 
                        <p class="variable"><b>Fecha: </b><%=rs.getString("fecha")%> </p>
                        <p class="variable"><b>Precio: </b><%=rs.getString("precio")%> </p>  
                            <div class=" d-flex justify-content-center">
                            <form action="actualizarmed.jsp" method="POST" >
                                <input type="hidden" name="cedula" value="<%=rs.getString("cedula")%>">
                                    <button type="submit" style="margin-right: 15%;">
                                        <span class="material-symbols-outlined">edit</span>
                                    </button>
                        </form>
                        <form action="eliminarmed.jsp" method="POST">
                            <input type="hidden" name="cedula" value="<%=rs.getString("cedula")%>">
